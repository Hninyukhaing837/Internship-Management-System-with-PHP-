...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	  ...
	  <div class="collapse navbar-collapse" id="navbarColor01">
		...
		<li class="nav-item">
		<a class="nav-link" href="<?php echo $url; ?>/admin/user_list.php">User List</a>
		</li>
		<li class="nav-item">
		<a class="nav-link" href="<?php echo $url; ?>/admin/post_list.php">Post List</a>
		</li>
		<li class="nav-item">
		<a class="nav-link" href="<?php echo $url; ?>/admin/settings.php">Settings</a>
		</li>
